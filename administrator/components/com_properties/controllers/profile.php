...
class PropertiesControllerProfile extends JControllerForm
{
		...
		if($allow)
			...
			if($recordId != 0)
				...
				$joomlaId = $record->mid;
					...
					$link = 'index.php?option=com_properties&task=profile.edit&id='.$Profile->id;
	...
	$path_image = JPATH_SITE.'/images/properties/profiles/';
