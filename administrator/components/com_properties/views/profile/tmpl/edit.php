...
<form action="<?php JRoute::_('index.php?option=com_properties'); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data" >
...
<?php echo JHtml::_('bootstrap.addTab', 'myPropTab', 'details', JText::_('COM_PROPERTIES_IMAGES', true)); ?>    
    
<div class="width-100 fltlft"> 
                
            <fieldset class="adminform">
			<legend><?php echo JText::_('COM_PROPERTIES_MANAGER_PRODUCT_IMAGES'); ?></legend>   
      <?php
                  if(!$this->item->id)
				  	{
					echo JText::_('COM_PROPERTIES_SAVE_DATA_TO_ADD_IMAGES');
					}else{					
					$profile_path = JURI::root().'images/properties/profiles/';
                    ?>   
		<table>  	         
