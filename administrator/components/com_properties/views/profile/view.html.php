...
class PropertiesViewProfile extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_PROPERTIES_MANAGER_PROFILE_NEW') : JText::_('COM_PROPERTIES_MANAGER_PROFILE_EDIT').' : '.$this->item->name, 'profiles.png');
