...
?>
<form action="<?php echo JRoute::_('index.php?option=com_properties&view=categories&layout=modal&tmpl=component');?>" method="post" name="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				<th class="left">
					<?php echo JHtml::_('grid.sort', 'Category Name', 'a.name', $listDirn, $listOrder); ?>
				</th>
