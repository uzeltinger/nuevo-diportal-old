...
<script type="text/javascript">
	...
	{
		if (task == 'locality.cancel' || document.formvalidator.isValid(document.id('item-form')))
		{
...
<form action="<?php JRoute::_('index.php?option=com_properties'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
