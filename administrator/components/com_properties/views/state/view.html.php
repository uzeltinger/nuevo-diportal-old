...
class PropertiesViewState extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_PROPERTIES_MANAGER_STATE_NEW') : JText::_('COM_PROPERTIES_MANAGER_STATE_EDIT'), 'states.png');
