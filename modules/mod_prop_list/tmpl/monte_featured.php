...
jQuery('.btn_view_details').click(function(e){
	let ref = jQuery(this).attr('data-ref'); 
	console.log("ref",ref);
	ga('send', 'event', 'Properties', 'viewDetail', ref);	
});
...
<div title="<?php echo str_replace('"',' ',$item->name); ?>" class="col-ss-12 col-xs-6 col-sm-6 col-md-3 col-lg-3<?php echo $paresClass;?>">
	<div class="panel panel-default pan-property">		
		...
		<div class="list-group">
			...
			<span class="list-group-item overflow-hiden"><?php echo $item->address; ?></span> 
		...
		<div class="panel-footer">
			<div class="row">
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
					<p><a class="btn btn-md btn-success btn-block btn_view_details" data-ref="<?php echo $item->ref; ?>" href="<?php echo $item->link; ?>" title=""><?php echo JText::_('Detalles'); ?></a></p>
				</div>
			</div>
		</div>
	</div>
